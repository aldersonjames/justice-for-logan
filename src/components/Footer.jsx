    ...
    <footer className="relative bg-gradient-to-br from-gray-900 via-slate-800 to-gray-900 text-white overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          {/* About */}
          <div>
            <h3 className="text-xl font-display font-bold mb-4 text-primary-light">Justice for Logan</h3>
            <p className="text-gray-300 text-sm leading-relaxed mb-4">
              Honoring the life of Logan Federico and fighting for criminal justice reform to prevent similar tragedies.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="#booking" className="text-gray-300 hover:text-white transition-colors">Media Inquiries</a></li>
              <li><a href="#guestbook" className="text-gray-300 hover:text-white transition-colors">Guestbook</a></li>
            </ul>
          </div>

          {/* Connect */}
          <div>
            <h4 className="font-semibold mb-4 text-primary-light">Connect & Support</h4>
            <div className="space-y-3">
              ...
              >
                ...
                <span>Support the Family (GoFundMe)</span>
              </a>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-700 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <p className="text-gray-400 text-sm text-center md:text-right">
              Designed with love in memory of Logan Federico 
